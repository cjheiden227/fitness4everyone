...
(function() {
  $(document).ready(function() {
    $('form.new_contact').submit(function() {
      ...
      return $('.modal-area').removeClass('sent fail');
    });
    $(document).bind("ajaxSuccess", "form.new_contact", function(event, xhr, settings) {
      $('.spinner').hide();
      $('.sent').show();
      $('.modal-area').addClass('sent');
      $('.lead').text('Message Sent!');
      return $('form.new_contact').trigger('reset').resetClientSideValidations();
    });
    return $(document).bind("ajaxError", "form.new_contact", function(event, jqxhr, settings, exception) {
      var response;
      $('.spinner').hide();
      $('.fail').show();
      ...
      return $.each(response.errors, function(key, value) {
        return $('.modal-area').append("<p> " + key + " " + value + " </p>");
      });
    });
  });
